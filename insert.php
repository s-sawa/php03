...
//３．データ登録SQL作成
$sql = "INSERT INTO my_tabelog(name,r_name,r_url,r_kind,visit_date,rate,impression,img_path,indate)VALUES(:name, :r_name, :r_url, :r_kind, :visit_date,:rate,:impression, :img_path, sysdate());";
